...
export interface ArchiveNodeProps extends BoxStyleProps {
  x?: number;
  y?: number;
  iconColor?: string;
}

/** Boxicons Solid `bxs:box` (24×24). */
const ARTBOARD = 24;
const BOX_PATH = 'M2 3h20v4H2zm17 5H3v11a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8zm-3 6H8v-2h8z';

export function ArchiveNode(props: ArchiveNodeProps) {
  const resolvedSize = resolveArchiveComponentSize(props.size, ARCHIVE_SIZE_PRESETS.lg);
  ...
  const iconColor = props.iconColor ?? '#d97706';

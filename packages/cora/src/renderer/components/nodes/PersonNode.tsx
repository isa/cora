...
export interface PersonNodeProps extends BoxStyleProps {
  x?: number;
  y?: number;
  iconColor?: string;
}
...
const ARTBOARD = 24;
// gridicons:user (GPL 2.0, Automattic)
const PERSON_PATH =
  'M12 4a4 4 0 1 1 0 8a4 4 0 0 1 0-8m0 16s8 0 8-2c0-2.4-3.9-5-8-5s-8 2.6-8 5c0 2 8 2 8 2';

export function PersonNode(props: PersonNodeProps) {
  const resolvedSize = resolvePersonComponentSize(props.size, PERSON_SIZE_PRESETS.lg);

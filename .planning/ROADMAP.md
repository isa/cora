...
- ELK auto-layout must not post-snap to grid by default (golden stability).
- Phase 4 canvas save rounds positions via core/grid helpers — document only in this phase.
